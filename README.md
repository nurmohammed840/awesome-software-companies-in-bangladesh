...
| 11 | Apex DMIT | — | `Flutter` `JavaScript` `PHP` `Python` | [Web](https://www.apexdmit.com/) |
| 12 | Appnap | — | `iOS` | [Web](https://www.appnap.io/) |
...
| 15 | Appyfilab | — | `Flutter` `Laravel` `NodeJS` `Nuxt` | [Web](https://www.appifylab.com/) |
...
| 23 | Bangladesh Software Solution | — | `C#` `VueJS` | [Web](https://bssoln.com/) |
| 24 | Bdtask | — | `Android` `WordPress` | [Web](https://www.bdtask.com/) |
...
| 65 | FIGLAB | — | `PHP` | [Web](https://figlab.io/) |
...
| 70 | Flyte Solutions | — | `Android` `NodeJS` `ReactNative` `iOS` | [Web](https://flytesolutions.com) |
...
| 73 | Furqan Software | — | `Elasticsearch` `Firebase` `Go` `Laravel` `MongoDB` `RabbitMQ` `React` `Redis` | [Web](https://furqansoftware.com/) |
| 74 | GeekSSort | — | `Flutter` `Laravel` `NextJS` `Shopify` `TestAutomation` `VueJS` `WordPress` | [Web](https://geekssort.com/) |
...
| 81 | HawarIT | — | `C#` | [Web](https://www.hawarit.com/career-at-hawarit/) |
...
| 90 | IXORA Solution | — | `Django` `Flutter` `MongoDB` `NodeJS` `React` `SQL` `SpringBoot` `Swift` `TypeScript` `VueJS` | [Web](https://ixorasolution.com) |
...
| 100 | Inument | — | `AI` `Flutter` `Java` `NodeJS` `PHP` `React` `nopCommerce` | [Web](https://inument.com/careers/#available-jobs) |
| 101 | Invento Software Limited | — | `Django` `JavaScript` `WordPress` | [Web](http://invento.com.bd/) |
| 102 | Inverse.AI | — | `Android` `iOS` | [Web](https://inverseai.com/) |
...
| 105 | Jatri Services Limited | — | — | [Web](https://www.jatri.co) |
...
| 139 | Next Ventures | — | `AWS` `Linux` `PostgreSQL` `Python` `TypeScript` | [Web](https://nextventures.io) <br> [LinkedIn](https://www.linkedin.com/company/nextventuresofficial) |
...
| 142 | Nogor Solutions Limited | — | `CakePHP` `Docker` `MongoDB` `MySQL` `Vuex` | [Web](https://www.nogorsolutions.com) |
...
| 145 | Ollyo | — | `JoomShaper` `Themeum` | [Web](https://www.ollyo.com) <br> [LinkedIn](https://www.linkedin.com/company/ollyo/) |
| 146 | Onecodesoft | — | `Flutter` `Laravel` `NodeJS` `Python` | [Web](https://onecodesoft.com) <br> [LinkedIn](https://www.linkedin.com/company/onecodesoft) |
...
| 158 | Pridesys IT Limited | — | `MySQL` `WordPress` `jQuery` | [Web](https://pridesys.com) |
| 159 | Progoti Systems Limited | — | `Android` `Django` `Docker` `MySQL` `PostgreSQL` `Spring` | [Web](https://www.progoti.com/) |
| 160 | REVE Systems (Singapore) | — | `CloudComputing` `Java` | [Web](https://www.revesoft.com/) |
| 161 | ReliSource (USA) | — | `AWS` | [Web](http://www.relisource.com) |
| 162 | Remotion IT | — | — | [Web](https://www.remotionit.com) |
| 163 | Renessa Info Systems Ltd. | — | `CakePHP` `CodeIgniter` `Laravel` `jQuery` | [Web](http://www.renessainfosystems.com/) |
...
| 167 | Rokomari | — | `Flutter` `NextJS` `Python` `Spring` | [Web](https://www.rokomari.com/) |
| 168 | SCT Bangla Limited | — | `Angular` `Flutter` `Laravel` `React` `SQL` | [Web](https://www.sct-bangla.com/) |
...
| 171 | SSL Wireless | — | `Java` `JavaScript` `Laravel` `MySQL` | [Web](https://www.sslwireless.com/) |
...
| 175 | Sheba Technologies Limited | — | `Android` `C++` `Java` | [Web](https://www.shebatech.com.bd/) |
...
| 185 | SovWare | — | `Flutter` `JavaScript` `Laravel` `WordPress` | [Web](https://www.sovware.com/) <br> [LinkedIn](https://www.linkedin.com/company/sovware/) |
...
| 197 | Technohaven Company Limited | — | `Android` `Angular` `Blockchain` `ML` `NodeJS` `React` `Rust` `iOS` | [Web](https://technohaven.com) |
| 198 | Tekarsh | — | `JavaScript` `Spring` | [Web](https://tekarsh.com) |
