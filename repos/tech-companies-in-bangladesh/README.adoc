...
|Instalogic
|Challabon, Vai Vai Market, Dokkhinkhan, Dhaka
|Retail POS, Restaurant POS, Service POS, repairpos
|https://stockypos.com/[Website]
|Please update

|Instalogic
|Challabon, Vai Vai Market, Dokkhinkhan, Dhaka
|PHP, Laravel, MySQL, Java, JavaScript, Bootstrap, PostgreSQL,  Vue, WordPress.
|https://preoit.com/[Website]
|Please update
...
|Python, TypeScript, PostgreSQL, AWS, Linux (Debian), Claude Code
|https://nextventures.io[Website] https://www.linkedin.com/company/nextventuresofficial[LinkedIn]
|100+
